...
class TestProvider : ContentProvider() {
    ...
    //열의 데이터 타입을 MINE 타입 형태로 반환하는 메서드
    ...
    //컨탠트 프로바이더 객체가 생성되면 자동으로 호출되는 메서드
    //데이터베이스에 접근할 수 있는 객체를 생성하고 
    //접속에 성공하면 true, 실패하면 false 반환
    ...
    //select 용
    //uri  : 프로바이터 요청시 사용한 uri값
    //projection : 가져올 컬럼 이름 목록, null이면 모든 컬럼을 가져옴
